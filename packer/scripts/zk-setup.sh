...
sudo yum -y localinstall telegraf-1.21.4-1.x86_64.rpm
...
sudo mkdir /opt/jolokia-1.7.1
sudo chown zk:zk /opt/jolokia-1.7.1
tar -xvf jolokia-1.7.1-bin.tar.gz -C /opt
rm jolokia-1.7.1-bin.tar.gz

echo '
export JOLOKIA="-javaagent:/opt/jolokia-1.7.1/agents/jolokia-jvm.jar=port=7777,host=0.0.0.0"
